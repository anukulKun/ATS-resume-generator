...
`ATS Resume Generator` is a collection of Markdown prompts, Node.js scripts, and HTML templates. It is strictly a local execution tool. The maintainers do not host, deploy, or operate an AI system, nor do we provide API access to Large Language Models (LLMs).

Users download the code, run it on their own machines, and connect it to the AI provider they choose. The maintainers have no visibility into, control over, or responsibility for how the tool is used after download.
...
- When you use an AI CLI tool (your AI runner, Codex, OpenCode), your data is sent directly to the AI provider you chose. Review their privacy policies.
...
ATS Resume Generator interacts with career portals and job boards (Greenhouse, Lever, Ashby, Workday, and others).
...
- The maintainers actively reject contributions that facilitate ToS violations (see [CONTRIBUTING.md](CONTRIBUTING.md)).

## 5. Acceptable Use

ATS Resume Generator is designed to help individuals make better career decisions, not to automate away human judgment. Acceptable use includes:
...
By using ATS Resume Generator, you agree to indemnify, defend, and hold harmless the authors, contributors, and any affiliated parties from and against any and all claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from your use of this software, your violation of these terms, or your violation of any third-party terms of service.

## 8. Cost Responsibility

If you use paid AI providers, you are solely responsible for monitoring and managing your own usage and costs. The maintainers are not responsible for unexpected charges.
