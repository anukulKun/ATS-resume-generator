...
/**
 * cv-sync-check.mjs — Validates that the ATS Resume Generator setup is consistent.
 *
 * Checks:
 * 1. cv.md exists
...
if (!existsSync(profilePath)) {
  errors.push('config/profile.yml not found. Copy from starter-kit/profile.example.yml and fill in your details.');
} else {
...
// Output results
console.log('\n=== ATS Resume Generator sync check ===\n');
