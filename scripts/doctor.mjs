...
/**
 * doctor.mjs — Setup validation for ATS Resume Generator
...
function checkCv() {
  ...
  return {
    pass: true,
    label: 'cv.md not found yet (create this during setup)',
  };
}
...
function checkProfile() {
  ...
  return {
    pass: true,
    label: 'config/profile.yml not found yet (copy from starter-kit/profile.example.yml during setup)',
  };
}
...
function checkPortals() {
  ...
  return {
    pass: true,
    label: 'portals.yml not found yet (copy from starter-kit/portals.example.yml when you want scanning)',
  };
}
...
async function main() {
  ...
  if (failures > 0) {
    ...
    console.log('Result: All checks passed. You\'re ready to go! Start your chosen AI runner in this folder.');
    process.exit(0);
  }
}
