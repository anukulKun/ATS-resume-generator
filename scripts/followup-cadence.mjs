#!/usr/bin/env node
/**
 * followup-cadence.mjs — Follow-up Cadence Tracker for ATS Resume Generator
 *
 ...
 *      node scripts/followup-cadence.mjs --summary   (human-readable summary)
...
const FOLLOWUPS_FILE = join(PROJECT_ROOT, 'data/follow-ups.md');
